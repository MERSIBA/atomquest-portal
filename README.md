...
The engine strictly enforces specific business logic parameters before processing records into the reviewer tables:

* **Total Weightage Balance:** The total collective sum of goal weights inside a single sheet must hit exactly **100%**.
* **Minimum Weight Floor:** Every single structural goal configured must carry a weight value of at least **10%**.
* **Maximum Volume Boundary:** An employee goal sheet is strictly limited to a maximum of **8 individual goals**.
